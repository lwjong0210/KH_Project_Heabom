...
CREATE TABLE TB_FILE (
   LOGO_NO VARCHAR2(100) PRIMARY KEY,
...
COMMENT ON COLUMN TB_FILE.STATUS IS '사용 Y | 미사용 N';
...
VALUES ('SEQ_MNO.NEXTVAL1','무궁화','admin','admin','관리자','관리자','admin@admin.com','ISTJ','010-1234-5678',SYSDATE,'Y','곰돌이사진','2023-02-10','1988-01-01',99999);
...
VALUES ('SEQ_MNO.NEXTVAL4','잔디','user03','pass03','홍상원','잘생긴상원','upOne@kakao.com','010-3698-4578','N','악어사진','2000-12-31',400);
INSERT INTO TB_MEMBER (MEM_NO,GRADE,MEM_ID,MEM_PWD,MEM_NAME,NICKNAME,EMAIL,MBTI,MEM_PHONE,MEM_BIRTHDAY,MEM_POINT)
...
INSERT INTO TB_FREE_BOARD VALUES('SEQ_FBNO.NEXTVAL1', 'SEQ_MNO.NEXTVAL1', '안녕하세요1', 1, DEFAULT, 'Y', 'N', 'bgsample.PNG');
INSERT INTO TB_FREE_BOARD VALUES('SEQ_FBNO.NEXTVAL2', 'SEQ_MNO.NEXTVAL1', '안녕하세요2', 20, DEFAULT, 'N', 'N', 'apple.PNG');
INSERT INTO TB_FREE_BOARD VALUES('SEQ_FBNO.NEXTVAL3', 'SEQ_MNO.NEXTVAL1', '안녕하세요3', 33, DEFAULT, 'Y', 'N', 'banana.PNG');

INSERT INTO TB_REPLY VALUES('SEQ_RPNO.NEXTVAL1','SEQ_MNO.NEXTVAL1','SEQ_FBNO.NEXTVAL1','좋은 글 감사',23,DEFAULT,'Y','N','ASDF.IMG');
INSERT INTO TB_REPLY VALUES('SEQ_RPNO.NEXTVAL2','SEQ_MNO.NEXTVAL2','SEQ_FBNO.NEXTVAL2','우왕',13,'23-06-18','N','N',NULL);
INSERT INTO TB_REPLY VALUES('SEQ_RPNO.NEXTVAL3','SEQ_MNO.NEXTVAL3','SEQ_FBNO.NEXTVAL3','하이룽~',3,DEFAULT,'Y','Y','GG.IMG');

INSERT INTO TB_REVIEW VALUES('SEQ_RVNO.NEXTVAL1','SEQ_PNO.NEXTVAL1','SEQ_MNO.NEXTVAL1',DEFAULT,'맛집이네유','QQQQ.IMG',DEFAULT);
INSERT INTO TB_REVIEW VALUES('SEQ_RVNO.NEXTVAL2','SEQ_PNO.NEXTVAL2','SEQ_MNO.NEXTVAL2','23-08-20','굳쟙','ㅋㅋㅋ.IMG','Y');
INSERT INTO TB_REVIEW VALUES('SEQ_RVNO.NEXTVAL3','SEQ_PNO.NEXTVAL3','SEQ_MNO.NEXTVAL3',DEFAULT,'흐음~별룬디',NULL,DEFAULT);
...
INSERT INTO TB_NOTICE VALUES('SEQ_NNO.NEXTVAL1','SEQ_MNO.NEXTVAL1','필독!',330,DEFAULT,DEFAULT,'Y','공지사항.IMG');
INSERT INTO TB_NOTICE VALUES('SEQ_NNO.NEXTVAL2','SEQ_MNO.NEXTVAL2','공지입니다!',230,'23-01-03','N','N','흠냐링.IMG');
INSERT INTO TB_NOTICE VALUES('SEQ_NNO.NEXTVAL3','SEQ_MNO.NEXTVAL3','점검할게요',30,'22-11-30',DEFAULT,'Y','공지염.IMG');

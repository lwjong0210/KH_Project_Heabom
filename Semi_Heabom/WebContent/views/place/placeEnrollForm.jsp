...
<div class="place_Insert_Outer" aling="center">
    ...
    <div class="placeOuter" align="center">
        <form action="<%=plcontextPath%>/insert.pl" method="post" enctype="multipart/form-data">
            <table class="insertBox" border="1" style="text-align: center;">
                <tr>
                    <th width="85">장소명</th>
                ...
                <tr>
                    <th>상세이미지</th>
                    <td align="center"><img id="contentImg1" width="150" height="120" onclick="chooseFile(2);"></td>
                    <td align="center"><img id="contentImg2" width="150" height="120" onclick="chooseFile(3);"></td>
                    <td align="center"><img id="contentImg3" width="150" height="120" onclick="chooseFile(4);"></td>
                </tr>
            </table>
            ...
            <div class="insertSubmitReset" align="center">
                ...
                <button class="btn btn-sm btn-warning" type="reset">초기화</button>

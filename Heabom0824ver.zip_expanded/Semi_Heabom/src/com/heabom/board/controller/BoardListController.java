...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String selectBoardLimit= request.getParameter("pageLimit");
		if(selectBoardLimit == null) {
			boardLimit= 10;
		}else {
			boardLimit= Integer.parseInt(request.getParameter("pageLimit"));
		}
		pageLimit = 10;
		...
		System.out.println("흠냐흠ㄴ먀힝"+pi.getBoardLimit());
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		System.out.println("boardlimit 크기"+list.size());

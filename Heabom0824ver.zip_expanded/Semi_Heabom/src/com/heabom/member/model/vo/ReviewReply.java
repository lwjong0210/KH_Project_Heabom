...
public class ReviewReply {
	...
	public ReviewReply(String reNo, String reRefNo, String reWriter, String reOriginWriter, String reContent,
			String reLikeStar, Date reDate, String reLevel, String reStatus) {
		super();
		this.reNo = reNo;
	...
	public ReviewReply(String reNo, String reRefNo, String reWriter, String reContent, String reLikeStar, Date reDate,
	...
	public String getReLikeStar() {
		return reLikeStar;
	}

	public void setReLikeStar(String reLikeStar) {
		this.reLikeStar = reLikeStar;
	}
	...
	public String toString() {
		return "ReviewReply [reNo=" + reNo + ", reRefNo=" + reRefNo + ", reWriter=" + reWriter + ", reOriginWriter="
				...
				+ ", reLevel=" + reLevel + ", reStatus=" + reStatus + "]";
	}
